    ...
    $(".item-drag").draggable({
        ...
        start: function(event, ui) {
            ...
            if (dragAmount == 0) {
                ...
                let amountText = itemData.amount;
...
function optionSwitch(
    ...
    if ($toSlot < 6) {
        let amountText = fromData.amount;
        ...
        if (
            ...
            if (fromData.amount == $toAmount) {
                ...
                if ($toSlot < 6 && $toInv.attr("data-inventory") == "player") {
                    let amountText = newData.amount;
                    if (newData.name === 'cash') {
                        amountText += '$';
                    }
                    $toInv
                    .find("[data-slot=" + $toSlot + "]")
                ...
                if ($fromInv.attr("data-inventory").split("-")[0] == "itemshop") {
                    ...
                    if ($fromSlot < 6 && $fromInv.attr("data-inventory") == "player") {
                        let amountText = newDataFrom.amount;
                        if (newDataFrom.name === 'cash') {
                            amountText += '$';
                        }
                        ...
                        $fromInv
                            ...
                            .html(
                                ...
                                '<div class="item-slot-img"><img src="images/' + newDataFrom.image + '" alt="' + newDataFrom.name + '" /></div>' +
                                '<div class="item-slot-amount"><p>' + amountText + '</p></div>' +
                                '<div class="item-slot-name"><p> ' + ((newDataFrom.weight * newDataFrom.amount) / 1000).toFixed(1) + '</p></div>' +
                                ItemLabel
                            );
                        ...
                        $fromInv
                            ...
                            .html(
                                '<div class="item-slot-img"><img src="images/' + newDataFrom.image + '" alt="' + newDataFrom.name + '" /></div>' +
                                '<div class="item-slot-amount"><p>' + amountText + '</div>' +
                                '<div class="item-slot-name"><p> ' + ((newDataFrom.weight * newDataFrom.amount) / 1000).toFixed(1) + '</p></div>' +
                                ItemLabel
                            );
            ...
            if (fromData.amount == $toAmount) {
                ...
                if ($toSlot < 6 && $toInv.attr("data-inventory") == "player") {
                    ...
                    $toInv
                        .find("[data-slot=" + $toSlot + "]")
                        .html(
                            '<div class="item-slot-key"><p>' + $toSlot + '</p></div>' +
                            '<div class="item-slot-img"><img src="images/' + fromData.image + '" alt="' + fromData.name + '" /></div>' +
                            '<div class="item-slot-amount"><p>' + amountText + '</div>' +
                            '<div class="item-slot-name"><p> ' + ((fromData.weight * fromData.amount) / 1000).toFixed(1) + '</p></div>' +
                            ItemLabel
                        );
                ...
                if (toData != undefined) {
                    ...
                    if ($fromSlot < 6 && $fromInv.attr("data-inventory") == "player") {
                        ...
                        $fromInv
                            .find("[data-slot=" + $fromSlot + "]")
                            .html(
                                '<div class="item-slot-key"><p>' + $fromSlot + '</p></div>' +
                                '<div class="item-slot-img"><img src="images/' + toData.image + '" alt="' + toData.name + '" /></div>' +
                                '<div class="item-slot-amount"><p>' + amountText + '</div>' +
                                '<div class="item-slot-name"><p> ' + ((toData.weight * toData.amount) / 1000).toFixed(1) + '</p></div>' +
                                ItemLabel
                            );
                ...
                if ($toSlot < 6 && $toInv.attr("data-inventory") == "player") {
                    let amountText = newDataTo.amount;
                    if (newDataTo.name === 'cash') {
                        amountText += '$';
                    }
                    ...
                    $toInv
                        ...
                        .html(
                            '<div class="item-slot-key"><p>' + $toSlot + '</p></div>' +
                            '<div class="item-slot-img"><img src="images/' + newDataTo.image + '" alt="' + newDataTo.name + '" /></div>' +
                            '<div class="item-slot-amount"><p>' + amountText + '</div>' +
                            '<div class="item-slot-name"><p> ' + ((newDataTo.weight * newDataTo.amount) / 1000).toFixed(1) + '</p></div>' +
                            ItemLabel
                        );
                ...
                if (item != null) {
                    ...
                    if (item.slot < 6) {
                        ...
                        $(".player-inventory")
                            .find("[data-slot=" + item.slot + "]")
                            .html(
                                '<div class="item-slot-key"><p>' + item.slot + '</p></div>' +
                                '<div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div>' +
                                '<div class="item-slot-amount"><p>' + amountText + '</p></div>' +
                                '<div class="item-slot-name"><p> ' + ((item.weight * item.amount) / 1000).toFixed(1) + '</p></div>' +
                                ItemLabel
                            );
                ...
                if (item != null) {
                    ...
                    if (item.slot == 43) {
                        ...
                        $(".z-hotbar-inventory")
                            .find("[data-zhotbarslot=" + item.slot + "]")
                            .html(
                                '<div class="z-hotbar-item-slot-key"><p>6 <i style="top: -62px; left: 58px;" class="fas fa-lock"></i></p></div>' +
                                '<div class="z-hotbar-item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div>' +
                                '<div class="z-hotbar-item-slot-amount"><p>' + amountText + '</p></div>' +
                                '<div class="z-hotbar-item-slot-amount-name"><p> ' + ((item.weight * item.amount) / 1000).toFixed(1) + '</p></div>' +
                                ItemLabel
                            );
